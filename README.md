...
1. Clona el repositorio:
   ```bash
   git clone [https://github.com/carlosbrionesrappi-dotcom/nombre-del-repo.git](https://github.com/carlosbrionesrappi-dotcom/nombre-del-repo.git](https://github.com/carlosbrionesrappi-dotcom/sp6-telecom-analysis.git)](https://github.com/carlosbrionesrappi-dotcom/sp6-telecom-analysis.git)
